...
public class BookingRequest extends AbstractDTO<BookingRequest>{
	private String boId;
	...
	private List<BookingDetailsRequest> listSer;
	...
	public BookingRequest(String boId, String employeeId, String userId, String boPhoneNo, String boStatus, String boNote,
			String boStartTime, String boEndTime, Float boTotal, List<BookingDetailsRequest> listSer) {
		super();
		this.boId = boId;
	...
	public List<BookingDetailsRequest> getlistSer() {
		return listSer;
	}

	public void setlistSer(List<BookingDetailsRequest> listSer) {
		this.listSer = listSer;
	}
}
