...
public class OrderProRequest extends AbstractDTO<OrderProRequest>{
	...
	private Collection<OrderProDetailsRequest> listPro;
	
	
	public OrderProRequest() {
	}

	public OrderProRequest(String orProId, String orProUserId, String orProUserName, String orProDob, String orProAddress,
	...
	public Collection<OrderProDetailsRequest> getListProId() {
		return listPro;
	}

	public void setListProId(Collection<OrderProDetailsRequest> listProId) {
